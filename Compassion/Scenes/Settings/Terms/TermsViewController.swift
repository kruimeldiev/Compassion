...
protocol TermsViewControllerProtocol: class, UIViewControllerRouting {
    func set(interactor: TermsInteractorProtocol)
    func set(router: TermsRouterProtocol)

    func displayTerms()
}

class TermsViewController: UIViewController, TermsViewControllerProtocol {

    // MARK: - DI
    var interactor: TermsInteractorProtocol?
